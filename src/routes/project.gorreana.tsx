        ...
        <section className="mt-16 grid grid-cols-1 gap-12 pb-24 md:grid-cols-12 md:gap-10">
          ...
          <aside className="md:col-span-6">
            <div className="md:sticky md:top-28 space-y-8 text-[14px] leading-[1.7] text-black">
              ...
              <p className="indent-12">
                For this academic project, the main goals were to develop a rebranding that
              ...
              <p className="pl-12 text-[#51514F]">
                ...
                packaging planning and assembly drawings, booklet design, a landing page, as well as
                physical mockups and a product photoshoot.
              </p>
            </div>
          </aside>
