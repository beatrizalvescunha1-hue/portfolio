          ...
          <aside className="md:col-span-6">
            <div className="md:sticky md:top-28 space-y-8 text-[14px] leading-[1.7] text-black">
              <p className="indent-12">
                This design exercise is a wedding stationery concept project
                based on a fictional narrative concept: a young, elegant couple
                passionate about photography.
              </p>
              <p className="pl-12">
                The visual representation draws on photographs by Karl
                Blossfeldt, placed side by side as a metaphor for distinct
                identities that chose to unite. The aesthetic is also inspired
                by processes such as cyanotype, integrating the couple's
                interests into the visual language itself. The project uses a
                restrained colour palette centred on neutrals and red, two type
                families to establish hierarchy and legibility, and a monogram
                formed from the couple's initials.
              </p>
            </div>
          </aside>
